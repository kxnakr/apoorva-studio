...
export default function GetInTouch() {
  return (
    <section
      className="mt-32 flex flex-col sm:flex-row justify-around"
      id="get-in-touch"
    >
      <div className="flex flex-col xl:flex-row flex-1">
        ...
        <Image
          ...
          height={322}
          unoptimized
          className="object-cover -rotate-6 mt-4 xl:mt-22 ml-auto  xl:-ml-32 2xl:-ml-24 max-w-[200px] sm:max-w-[300px] xl:max-w-none"
        />
      </div>
